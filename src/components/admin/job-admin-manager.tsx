...
export function JobAdminManager({ initialRows }: { initialRows: JobListItem[] }) {
  ...
  return (
    <div>
      <h1 className="text-2xl font-black text-[var(--foreground)]">Jobs</h1>
      <p className="mt-2 text-[var(--text-muted)]">Create, edit, and delete job opportunities.</p>
      ...
      <form onSubmit={handleCreate} className="mt-6 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          ...
          <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Organization" value={createForm.organization} onChange={(e) => onChange(setCreateForm, "organization", e.target.value)} required />
          <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Location" value={createForm.location} onChange={(e) => onChange(setCreateForm, "location", e.target.value)} required />
          <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Employment type" value={createForm.employmentType} onChange={(e) => onChange(setCreateForm, "employmentType", e.target.value)} required />
          <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)]" type="date" value={createForm.applicationDeadline} onChange={(e) => onChange(setCreateForm, "applicationDeadline", e.target.value)} required />
        </div>

        <textarea className="mt-3 min-h-24 w-full rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Description" value={createForm.description} onChange={(e) => onChange(setCreateForm, "description", e.target.value)} required />
        <input className="mt-3 w-full rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Official application URL" value={createForm.officialApplicationUrl} onChange={(e) => onChange(setCreateForm, "officialApplicationUrl", e.target.value)} required />
          ...
          <tbody>
            {sortedRows.map((row) => (
              <tr key={row.id} className="border-t border-[var(--border)]">
                ...
                <td className="px-3 py-2 text-[var(--foreground)]">{row.title ?? `Job #${row.id}`}</td>
                <td className="px-3 py-2 text-[var(--text-muted)]">{row.organization}</td>
                <td className="px-3 py-2 text-[var(--text-muted)]">{row.employmentType}</td>
                <td className="px-3 py-2 text-[var(--text-muted)]">{toDateInputValue(row.applicationDeadline)}</td>
      ...
      {editingId && (
        <form onSubmit={handleUpdate} className="mt-6 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-black uppercase tracking-wide text-[var(--foreground)]">Edit Job #{editingId}</h2>
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            ...
            <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Organization" value={editForm.organization} onChange={(e) => onChange(setEditForm, "organization", e.target.value)} required />
            <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Location" value={editForm.location} onChange={(e) => onChange(setEditForm, "location", e.target.value)} required />
            <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Employment type" value={editForm.employmentType} onChange={(e) => onChange(setEditForm, "employmentType", e.target.value)} required />
            <input className="rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)]" type="date" value={editForm.applicationDeadline} onChange={(e) => onChange(setEditForm, "applicationDeadline", e.target.value)} required />
          </div>

          <textarea className="mt-3 min-h-24 w-full rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Description" value={editForm.description} onChange={(e) => onChange(setEditForm, "description", e.target.value)} required />
          <input className="mt-3 w-full rounded border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-[var(--foreground)] placeholder:text-[var(--text-subtle)]" placeholder="Official application URL" value={editForm.officialApplicationUrl} onChange={(e) => onChange(setEditForm, "officialApplicationUrl", e.target.value)} required />
